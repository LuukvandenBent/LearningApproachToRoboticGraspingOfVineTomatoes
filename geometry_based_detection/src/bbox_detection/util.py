...
utils for RetinaNet detection model
"""
import os
...
def visualize_detections(
    image, boxes, classes, scores, ax=None, save=False, pwd_detections=None, file_name=None, idx=0, figsize=(7, 7), linewidth=1, color=[0, 0, 1]):
...
#         plt.figure(figsize=figsize)
    ...
    if save:
        plt.savefig(pwd_detections + file_name + '.png', dpi=150)
